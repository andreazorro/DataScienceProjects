...
def ml_reg(rs):
    ...
    ridge = Ridge(random_state=rs, max_iter=1000)
    ...
    lasso = Lasso(random_state=rs, max_iter=100000)
    ...
    elasticnet = ElasticNet(random_state=rs, max_iter=1000000)
    ...
    mlp = MLPRegressor(random_state=rs, max_iter=10000)
